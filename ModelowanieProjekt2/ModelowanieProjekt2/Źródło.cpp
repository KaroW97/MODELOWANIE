...
//TRANSPORT
//srand inicljalizacja 
double Transport(double randd) {
	fstream transportFile;
	transportFile.open("transport1.txt", ios::out | ios::app);
...
double Zakwaterowanie(double randd) {
	fstream roomFile;
	roomFile.open("apartaments1.txt", ios::out | ios::app);
...
double Food(double randd) {
	fstream foodFile;
	foodFile.open("food1.txt", ios::out | ios::app);
